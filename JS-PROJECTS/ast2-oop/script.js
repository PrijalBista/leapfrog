...
function Carousel (carouselContainer) {
	...
	this.updateHeightWidthOfContainer = function () {
		var windowWidth = window.innerWidth;
		if(windowWidth <= IMG_WIDTH) {

			// resize container and reposition the images in image wrapper
			var newHeight = IMG_HEIGHT - (IMG_WIDTH - windowWidth); 
			var newWidth = windowWidth;
			console.log('resizing carousel....', newWidth, newHeight);

			carouselContainer.style.width = newWidth + 'px';
	...
	this.init = function () {
		this.updateHeightWidthOfContainer();
		this.positionImages();
	...
	this.indicatorClicked = function (e) {
		...
		if(intervals) that.clearAllIntervals();
...
// Grabing All Carousel Containers
var carouselContainers = Array.from(document.getElementsByClassName('carousel-container'));
var carousels = [];

carouselContainers.forEach( function (carousel, i) {

	// Instantiating new Carousel Object
...
window.addEventListener('resize', function () {
	carousels.forEach( function (carousel) {
		carousel.updateHeightWidthOfContainer();
	});
});
